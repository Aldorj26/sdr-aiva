...
- Lojista perguntando "cadê meu acesso/login?" (⚠️ o padrão abaixo vale quando a instrução da fase NÃO disser nada sobre o acesso DESTA loja; se ela disser que a AIVA ainda não enviou, ou que já enviou, quem manda é ela) → primeiro oriente: "procura no seu WhatsApp uma mensagem do número +55 21 4020-2024 (Comunicados Aiva Pay) e clica em Sim, quero". Essa mensagem é LEGÍTIMA — confirme se ele desconfiar.
