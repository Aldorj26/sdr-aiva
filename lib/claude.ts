...
export async function processarMensagem(
  ...
  if (onbEtapaAberta && FASES_CADASTRO_ABERTO.includes(status)) {
    const detalhe = onbEtapaAberta === 'biometria'
