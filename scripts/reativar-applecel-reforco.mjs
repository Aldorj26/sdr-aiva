// Reativa conversa com AppleCel Celulares / Débora (5551999584395).
// Template CAF ja foi reenviado em 23/04 20:39 UTC (janela 24h ainda aberta mas prestes a fechar).
// A pedido do Aldo: reenviar template CAF + reforço pedindo pra concluir o cadastro.
...
const lead = {
  id:       'b6a5de4c-9fa3-468a-b34d-a36f3671949c',
  nome:     'Débora',
  loja:     'AppleCel Celulares',
  telefone: '5551999584395',
  chatId:   2258,
}
...
async function main() {
  // 1) Reenvia template CAF — abre/renova janela 24h
